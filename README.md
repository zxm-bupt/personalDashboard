...
- 任务管理：任务标题、描述、DDL、重要程度、网页 URL 资源
- 时间记录：番茄钟、上下班打卡、任务专注计时

当前版本只支持 **网页 URL**，不支持本地文件和本地软件启动。后续可以通过 Tauri 2 包装成 macOS / Windows / Linux 桌面应用，并补齐文件和软件打开能力。
